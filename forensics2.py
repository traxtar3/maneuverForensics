...
def forensics(sat_dic):
    ...
    for i in arange(begin, final, 1):
        ...
        # ref = twobody2(sat_dic[i], sat_dic[i])
        # middle = (back1 + fwd1) / 2
        ...
        # plt.plot(x, y2, c='r', marker='o', markersize=1)

        # plt.plot(x, back3, c='b', marker='o', markersize=1)
        # plt.plot(x, back2, c='g', marker='o', markersize=1)
        plt.plot(x, back1, c='r', marker='o', markersize=1)
        # plt.plot(x, middle, c='c', marker='o', markersize=1)
        # plt.plot(x, fwd1, c='m', marker='o', markersize=1)
        # plt.plot(x, fwd2, c='y', marker='o', markersize=1)
        # plt.plot(x, fwd3, c='k', marker='o', markersize=1)
